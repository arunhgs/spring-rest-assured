...
@javax.annotation.Generated(
    ...
    comments = "Source: balance-service.proto")
public final class BalanceServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.sample.grpcsample.balanceService.BalanceRequest,
      com.sample.grpcsample.balanceService.BalanceResponse> getGetBalanceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getBalance",
      requestType = com.sample.grpcsample.balanceService.BalanceRequest.class,
      responseType = com.sample.grpcsample.balanceService.BalanceResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.sample.grpcsample.balanceService.BalanceRequest,
      com.sample.grpcsample.balanceService.BalanceResponse> getGetBalanceMethod() {
    io.grpc.MethodDescriptor<com.sample.grpcsample.balanceService.BalanceRequest, com.sample.grpcsample.balanceService.BalanceResponse> getGetBalanceMethod;
      ...
      synchronized (BalanceServiceGrpc.class) {
        if ((getGetBalanceMethod = BalanceServiceGrpc.getGetBalanceMethod) == null) {
          BalanceServiceGrpc.getGetBalanceMethod = getGetBalanceMethod = 
              io.grpc.MethodDescriptor.<com.sample.grpcsample.balanceService.BalanceRequest, com.sample.grpcsample.balanceService.BalanceResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "BalanceService", "getBalance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sample.grpcsample.balanceService.BalanceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sample.grpcsample.balanceService.BalanceResponse.getDefaultInstance()))
  ...
  public static abstract class BalanceServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getBalance(com.sample.grpcsample.balanceService.BalanceRequest request,
        io.grpc.stub.StreamObserver<com.sample.grpcsample.balanceService.BalanceResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.sample.grpcsample.balanceService.BalanceRequest,
                com.sample.grpcsample.balanceService.BalanceResponse>(
  ...
  public static final class BalanceServiceBlockingStub extends io.grpc.stub.AbstractStub<BalanceServiceBlockingStub> {
    ...
    /**
     */
    public com.sample.grpcsample.balanceService.BalanceResponse getBalance(com.sample.grpcsample.balanceService.BalanceRequest request) {
  ...
  public static final class BalanceServiceFutureStub extends io.grpc.stub.AbstractStub<BalanceServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sample.grpcsample.balanceService.BalanceResponse> getBalance(
        com.sample.grpcsample.balanceService.BalanceRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BALANCE:
          serviceImpl.getBalance((com.sample.grpcsample.balanceService.BalanceRequest) request,
              (io.grpc.stub.StreamObserver<com.sample.grpcsample.balanceService.BalanceResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BalanceServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.sample.grpcsample.balanceService.BalanceServiceOuterClass.getDescriptor();
    }
